        ...
        <Row className="align-items-center">
            ...
            <InputGroup className="mb-2">
              ...
              <select required
                ...
                className="me-sm-2" input id="alias">
                    <option active selected disabled value="">Select Category</option>
          ...
          <Col xs="auto">
            ...
            <InputGroup className="mb-2">
              ...
              <FormControl required onChange={
                (e) => {setLocation(e.target.value);
                }
                }input id="zipcode" placeholder="30080" minLength={5} maxLength={5}/>
            </InputGroup>
          </Col>
                ...
                <div key={index} className = "contractorCard">
                  <Card style={{ width: '15rem' }}>
                    <Card.Img variant="top" height="165px" width="70px"src={contractor.image_url}/>
                      <Card.Body>
                        <Card.Title><h6>Name:</h6><h6>{contractor.name}</h6></Card.Title>
                          <Card.Text><h6>Phone:</h6><h6>{contractor.display_phone}</h6></Card.Text>
                          <Card.Text><h6>Rating:</h6> <h6>{contractor.rating}</h6></Card.Text>
                          <Card.Text><h6>Rating:</h6> <h6>{contractor.rating}</h6></Card.Text>
                          <Button variant="primary" onClick = {()=> handleShow(contractor)}>Assign Contractor
                          </Button>  
